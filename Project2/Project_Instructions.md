# Project Part 2: Advanced Data Structures and I/O
Due: Dec 1, 2025 (Late Due Date: Dec 4, 2025)
...
**Note: You may work alone or in a group of two. Groups of more than two members are not permitted.**
...
Stack/Queue, BST, Priority Queue, or Hash Table (Map). *Note: You may use a stack or a queue, but not both.*
...
* Chosen dataset and motivation for selection (you can replicate from Part 1 report if you choose to use the same dataset).
...
**Compile**
```bash
g++ main.cpp PQueue.cpp -o program
./program
```